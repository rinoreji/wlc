...
function updateChart() {
    ...
    tankChart.data.labels = [ new Date(latestData.timestamp).toLocaleTimeString()];
...
var initFetch = false;
var sensorDataRef = database.ref('sensor-data').orderByChild('timestamp').limitToLast(100);
